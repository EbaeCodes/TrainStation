...
public class Tower {
	...
	private final int towerPoints =6;
  ...
  public void draw(Color color, Color flagColor) {
	  int xPoints[]= {position.x+50,position.x+60,position.x+100,position.x+100,position.x+5,position.x+5};
	  int yPoints[]= {position.y-100,position.y-100,position.y-80,position.y-30,position.y-30,position.y-80};
